...
@Client.on_message(filters.text & filters.private & ~filters.command(["start", "cancel", "ask", "id", "set", "telegraph", "stickerid", "accept", "users", "broadcast", "rename"]) & ~filters.regex("https://t.me/"))           
